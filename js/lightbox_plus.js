...
Lightbox.prototype = {
  ...
  {
    if (Spica.Browser.isWinIE)
      elem.style.filter = 'alpha(opacity=' + (alpha * 8) + ')';
    else
      elem.style.opacity = alpha / 8;
  },
  _close_box : function()
  {
    var self = this;
...
Spica.Event.run(function() { 
  new Lightbox({
    loadingimg:'images/wedding/resource/loading.gif',
    expandimg:'images/wedding/resource/expand.gif',
    shrinkimg:'images/wedding/resource/shrink.gif',
    blankimg:'images/wedding/resource/blank.gif',
    previmg:'images/wedding/resource/prev.gif',
    nextimg:'images/wedding/resource/next.gif',
    closeimg:'images/wedding/resource/close.gif',
    //effectimg:'images/wedding/resource/zzoop.gif',
    effectpos:{x:-40,y:-10},
